...
public class FourrierManager {
    ...
    private long[] arrDt = new long[NB_DATAPOINT_ARCHIVED];
    ...
    public void FourrierCalc(){
        ...
        ((TextView)RoulisFragment.rootView.findViewById(R.id.infoText)).setText(FFT.calculate(arrX,20,dtMoy()).ampString());
    }
    private long dtMoy(){
        long total = 0;
        ...
        arrDt[0] = SystemClock.uptimeMillis() - lastCall;
        lastCall = SystemClock.uptimeMillis();
        return total/NB_DATAPOINT_ARCHIVED;
    }
